    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-green-100 flex flex-col">
      <main className="flex flex-1 flex-col items-center justify-center text-center px-4">
        <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-4 mt-8 md:mb-6 md:mt-12 px-2 md:px-0">
          Grow Your Business with <span className="text-blue-600">AI Powered XenoReach CRM</span>
        </h1>
        ...
        <section className="max-w-4xl w-full mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6">
            <div className="bg-white rounded-xl shadow-md border p-6 flex flex-col items-center">
